...
composition is active. The NODE-OS command input keeps native input, focus,
selection, composition, and horizontal scrolling behavior while presenting a
measured slanted caret at the real collapsed insertion point, or at the end of
an unfocused draft. Text ranges and active composition use the native caret and
selection presentation. The Shell-provided editing plane supplies mobile

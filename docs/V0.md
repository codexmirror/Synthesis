...
size). Upload requires an explicit absolute remote destination path and is
currently exposed only through the core/GameContext action; no Upload player
surface is included yet. RACK-OS

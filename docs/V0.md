...
Networks and a flat index of known Devices with their known Network
relationships. A Device page presents observed Device facts, known Network
relationships, known Services, Access, and Device actions. A Service row

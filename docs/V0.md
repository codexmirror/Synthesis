...
NODE-OS, its Terminal, and its read-only filesystem remain bound to the local
Device. No foreign operating surface, remote command execution, or remote
...
Filesystem mutation and remote filesystem access are not implemented.

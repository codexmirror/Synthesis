...
Experimental override (see "Software Removal" below) — makes a later Inspect
result shallow without erasing previously remembered enhanced evidence. A
...
Enhanced Inspect snapshots remain exactly as observed, and only a *new*
Inspect performed after restoration is shallow again. NODE Miner is ordinary

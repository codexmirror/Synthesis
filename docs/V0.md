...
for each client session. The current schema version is 17.
...
The player's local Device owns a canonical filesystem. GameState schema 17
...
identity and artifact-size shape makes the schema version 17.

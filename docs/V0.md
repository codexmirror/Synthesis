...
source's upload capacity and a destination's download capacity; it is not
consumed by Download yet and is not exposed through Scan, Discovery, or any
other player-facing surface. This capacity is canonical World Truth, not
Player Knowledge.
...
transfer capacity described above, make the schema version 18.

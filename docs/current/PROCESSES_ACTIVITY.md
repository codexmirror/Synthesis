...
The same canonical game-advancement boundary advances the one concrete pending
Petra Technician response from represented remaining milliseconds. That authored
delay is independent of `GameProcess` and consumes no Device runtime resources;

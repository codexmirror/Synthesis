...
describe('createInitialGameState', () => {
  ...
  it('separates identities and seeds explicit Primary Device ownership in schema version 94', () => {
    const state = createInitialGameState()
    expect(GAME_STATE_VERSION).toBe(94)
    ...
    expect(state.player.localDevice.filesystem).toEqual({
      ...
      files: [
        ...
        { kind: 'software_module', id: 'file-0003', path: '/home/user/downloads/ghostkey-1.0.mod', hostProductId: 'flipper', moduleId: 'credential-access', releaseId: 'flipper-credential-access-module-1.0', buildId: 'build-flipper-credential-access-module-1.0-v0', name: 'GhostKey', version: '1.0', sizeBytes: 1_600_000 },

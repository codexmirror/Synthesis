...
describe('createInitialGameState', () => {
  ...
  it('separates identities and seeds canonical local-device state in schema version 33', () => {
  ...
  it('seeds both SSH services with the same vulnerable GateSSH release identity', () => {

...
describe('NodeMail on Home', () => {
  it('registers its own launcher', () => {
    expect(appRegistry).toHaveProperty('mail')
...
describe('Thread', () => {
  ...
  it('distinguishes the player from the correspondent in the message history', async () => {
    ...
    expect(messages[2]).toHaveTextContent("Alright. First one's free. Try 203.0.113.42. Consumer endpoint. Small operation. That's all I have.")
  })

...
function renderTerminal(scanTarget: GameActions['scanTarget']) {
  ...
  const actions: GameActions = {
    ...
    clearRecentActivity: () => {}, removeRecentActivity: () => {}, authenticateDollarAccount: () => ({ status: 'invalid_credentials', state }), authenticateDollarAccountWithSavedSignIn: () => ({ status: 'no_saved_sign_in', state }), logoutDollarAccount: () => ({ status: 'not_signed_in', state }), transferDollars: () => ({ status: 'not_signed_in', state }), cancelFileTransfer: () => ({ status: 'not_found', state }), cancelLocalProcess: () => ({ status: 'not_cancellable', state }),

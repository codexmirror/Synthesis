...
function renderTerminal(scanTarget: GameActions['scanTarget']) {
  ...
  const actions: GameActions = {
    ...
    clearRecentActivity: () => {}, removeRecentActivity: () => {}, authenticateDollarAccount: () => ({ status: 'invalid_credentials', state }), cancelFileTransfer: () => ({ status: 'not_found', state }), cancelLocalProcess: () => ({ status: 'not_cancellable', state }),

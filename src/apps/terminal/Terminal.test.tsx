...
function renderTerminal(scanTarget: GameActions['scanTarget']) {
  ...
  const actions: GameActions = {
    ...
    installLocalSoftwarePackage: vi.fn(), installRemoteSoftwarePackage: vi.fn(), removeInstalledSoftware: vi.fn(), startFlipperModuleIntegration: vi.fn(), createRattlerPayload: vi.fn(),

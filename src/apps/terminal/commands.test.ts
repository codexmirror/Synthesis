...
describe('command dispatcher', () => {
  ...
  it('delegates install through the shared narrow operation and presents canonical results', () => {
    const installLocalSoftwarePackage = vi.fn(() => ({ status: 'started' as const, processId: 'process-0001', productId: 'nodescan' as const, releaseId: 'opaque', name: 'Canonical Scanner', version: '1.1', channel: 'experimental' }))

...
export function VeyraIcon({ name }: { name: VeyraIconName }) {
  const glyphs = {
    ...
    business: <><path d="M4.2 9.4h15.6v8.4a1.8 1.8 0 0 1-1.8 1.8H6a1.8 1.8 0 0 1-1.8-1.8z" /><path d="M9.2 9.4V6.7A1.7 1.7 0 0 1 10.9 5h2.2a1.7 1.7 0 0 1 1.7 1.7v2.7" /><path d="M4.2 13.4h15.6" /></>,

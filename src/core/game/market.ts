...
export function createInitialMarketState(): MarketState {
  return {
    ...
    offers: [
      {
        id: 'market-offer-rattler-1.0-v0', priceNodeUnits: MARKET_V1_OFFER_PRICE_NODE_UNITS,
        distribution: {
          artifact: 'software_package', filename: 'rattler-1.0.pkg', releaseId: RATTLER_1_0.releaseId, buildId: RATTLER_1_0.buildId,
          productId: RATTLER_1_0.productId, name: RATTLER_1_0.name, version: RATTLER_1_0.version,
          channel: RATTLER_1_0.channel, publisher: RATTLER_1_0.publisher, sizeBytes: 2_800_000,
        },
      },
      {

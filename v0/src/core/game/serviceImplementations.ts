...
export const BOOKSTORE_BACKEND_PRODUCT_ID = 'bookstore-backend'
export const BOOKSTORE_BACKEND_1_0_RELEASE_ID = 'bookstore-backend-1.0'
export const BOOKSTORE_BACKEND_1_0_BUILD_ID = 'build-bookstore-backend-1.0-v0'
